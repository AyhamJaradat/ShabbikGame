...
public class FileUtils {
    ...
    // Files names
    public static final String LOG_FILE_NAME = "headbox_log.txt";
    public static final String COMPRESSED_FILE_NAME = "database_log.zip";
    ...
    /**
     * Create needed folders, Save logs, Copy database & Encrypt db & compress
     * them in order to be sent by email.
     *
     * @param activity calling activity
     */
    public static void prepareDatabaseLogToSend(Activity activity) {

        String databasePath = activity.getDatabasePath(IDatabase.DATABASE_NAME)
                .getAbsolutePath();
        ...
        if (FileUtils.createFolder(FileUtils.HEADBOX_FOLDER_PATH)) {
            ...
            String[] filesToCompress = new String[]{databasePath, logsPath};

            // Compress application's data files.
            FileUtils.zipFiles(filesToCompress, FileUtils.COMPRESSED_FILE_PATH);
